...
# method 1 
# readin voxel 
voxel_path = './checkpoints_and_samples/fake_samples/700.pkl'
...
print(voxels.shape)
threhold_list = [-0.05, 0.05, 0.1, 0.15,0.2]
for th in threhold_list:
    utils.SavePloat_Voxels2offline(voxels, './checkpoints_and_samples/th_samples', threshold=th)
